...
AOnlyRPGCharacter::AOnlyRPGCharacter()
{
...
void AOnlyRPGCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AOnlyRPGCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
